...
def setup_optimizers(model, config):
    ...
    # Optimizers
    backbone_optimizer = tf.keras.optimizers.Adam(learning_rate=get_backbone_learning_rate)
    transformers_optimizer = tf.keras.optimizers.Adam(learning_rate=get_transformers_learning_rate)
    nlayers_optimizer = tf.keras.optimizers.Adam(learning_rate=get_nlayers_learning_rate)
